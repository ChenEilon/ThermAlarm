...
using ThermAlarm.FrontEnd.WebApp.Models;
using ThermAlarm.FrontEnd.WebApp.Models.ManageViewModels;
using ThermAlarm.FrontEnd.WebApp.Services;

namespace ThermAlarm.FrontEnd.WebApp.Controllers
{
    [Authorize]
    ...
    public class ManageController : Controller
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("ThermAlarm.FrontEnd.WebApp"),
